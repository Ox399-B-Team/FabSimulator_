...
BOOL CFabInfoListCtrl::InitListCtrl()
{
	...
	CFabController::GetInstance().m_pModule.push_back(new ProcessChamber(TYPE_PROCESSCHAMBER, _T("PM02"), 0, 4, 3, 6, 400, 120, 2, 2, 2));
	CFabController::GetInstance().m_pModule.push_back(new ProcessChamber(TYPE_PROCESSCHAMBER, _T("PM03"), 0, 4, 4, 6, 400, 120, 2, 2, 2));
