...
BOOL CFabInfoListCtrl::InitListCtrl()
{
	...
	CFabController::GetInstance().m_pModule.push_back(new LoadLock(TYPE_LOADLOCK, _T("LL1"), 0, 12, 2, 4, 15, 5, 15, 5, 2, 2, 2, 2));
	CFabController::GetInstance().m_pModule.push_back(new LoadLock(TYPE_LOADLOCK, _T("LL2"), 0, 12, 4, 4, 15, 5, 15, 5, 2, 2, 2, 2));
	...
	CFabController::GetInstance().m_pModule.push_back(new ProcessChamber(TYPE_PROCESSCHAMBER, _T("PM02"), 0, 6, 3, 6, 400, 120, 2, 2, 2));
	CFabController::GetInstance().m_pModule.push_back(new ProcessChamber(TYPE_PROCESSCHAMBER, _T("PM03"), 0, 6, 4, 6, 400, 120, 2, 2, 2));
